...
<details>
<summary><b>🎨 Frontend Architecture</b> (Click to expand)</summary>
...
│
├── 🧩 Components/
│   ├── AdminApprovalPage.tsx     # Admin user management
│   ├── AdminAuthScreen.tsx       # Admin authentication
│   ├── Analytics.tsx             # Data visualization
│   ├── AnalyticsPanel.tsx        # Report analytics
│   ├── AuthScreen.tsx            # Main auth handler
│   ├── ChatbotToggle.tsx         # AI assistant toggle
│   ├── ChatWindow.tsx            # Chatbot interface
│   ├── FilterPanel.tsx           # Report filtering
│   ├── Header.tsx                # Navigation header
│   ├── InteractiveMap.tsx        # Leaflet map integration
│   ├── LocationPicker.tsx        # GPS location selector
│   ├── LoginScreen.tsx           # User login
│   ├── MapDashboard.tsx          # Main dashboard view
│   ├── Notification.tsx          # Alert system
│   ├── PortalSelection.tsx       # Role-based routing
│   ├── ProfileModal.tsx          # User profile
│   ├── RejectModal.tsx           # Report rejection
│   ├── ReportForm.tsx            # Submit hazard reports
│   ├── ReportHistoryModal.tsx    # User report history
│   ├── ReportList.tsx            # List all reports
│   ├── SidePanel.tsx             # Side navigation
│   ├── SocialFeed.tsx            # Social media integration
│   └── UserAuthScreen.tsx        # Citizen authentication
│
├── 🌐 Locales/                    # 17+ Indian Languages
│   ├── en.json, hi.json          # English, Hindi
│   ├── ta.json, te.json          # Tamil, Telugu
│   ├── bn.json, gu.json          # Bengali, Gujarati
│   ├── ml.json, kn.json          # Malayalam, Kannada
│   ├── mr.json, pa.json          # Marathi, Punjabi
│   ├── or.json, as.json          # Odia, Assamese
│   └── ur.json, ks.json          # Urdu, Kashmiri
...
└── 🔧 Services/
    ...
    ├── backendApiService.ts      # Server integration
    ├── chatbotService.ts         # AI chatbot logic
    ├── geminiService.ts          # Google Gemini API
    ├── nlpService.ts             # NLP processing
    ├── oceanDataService.ts       # INCOIS integration
    ├── socialDataService.ts      # Social media feeds
    └── mockData.ts               # Development data
```
</details>

<details>
<summary><b>⚙️ Backend Architecture</b> (Click to expand)</summary>
...
│   ├── hotspots.ts               # Hazard hotspot data
│   ├── multilingual.ts           # Language switching
...
│
└── 📜 Scripts/
    └── create-test-approval-data.js  # Dev testing
```
</details>

<details>
<summary><b>📱 Mobile App (React Native)</b> (Click to expand)</summary>
